...
WGS_BRAND_KIT = BrandKit.model_validate(
    {
        ...
        "voice_samples": {
            ...
            # Revised 2026-07-15 (logbook #30) — all 5 original samples were
            # workplace/meeting-themed, which pulled draft_post toward inventing
            # office scenarios regardless of topic. Deliberately domain-diverse now
            # (Wellness / Women's Health / Relationships / Society / Mindset), none
            # anchored in a meeting, manager, or office scene.
            "direct": [
